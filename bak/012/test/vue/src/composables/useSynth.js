...
import synthWasmUrl from '../../../../dist/synth.wasm?url';
import echoWasmUrl from '../../../../dist/echo.wasm?url';
import filterWasmUrl from '../../../../dist/filter.wasm?url';
import flangerWasmUrl from '../../../../dist/flanger.wasm?url';
import waveshaperWasmUrl from '../../../../dist/waveshaper.wasm?url';
import auto_wahWasmUrl from '../../../../dist/auto_wah.wasm?url';
...
*/
  const plugCable = (sourceId, targetId) => {
    ...
    // Safety check: Prevent looping a node back into itself or adding duplicates
    ...
    // Store connection with a unique cable string ID descriptor
